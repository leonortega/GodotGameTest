...
- Expected output: Title screen visible with `Start Game`, `Controls`, `Enemies`, `Configuration`, and `Difficulty`, a dedicated logo, retro pixel lettering, and an animated chase vignette.
